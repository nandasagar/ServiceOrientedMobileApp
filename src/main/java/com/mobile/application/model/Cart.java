...
public class Cart {
	...
	public Cart(int id, String email, String itemname,int model, int quantity, int price, int total) {
		super();
		this.id=id;
		this.email = email;
		this.model = model;
	...
	public String toString() {
		return "Cart [cartid=" + cartid +",id="+id+ ", email=" + email + ", model=" + model + ", quantity=" + quantity
